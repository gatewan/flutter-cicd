...
void main() {
  ...
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponse.fromJson(json.decode(readJson('xtra_dummy/now_playing.json'))).movieList;
    ...
    test('should return list of Movie Model when the response code is 200', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/now_playing?$API_KEY')))
          .thenAnswer((_) async => http.Response(readJson('xtra_dummy/now_playing.json'), 200));
      // act
  ...
  group('get Popular Movies', () {
    final tMovieList = MovieResponse.fromJson(json.decode(readJson('xtra_dummy/popular.json'))).movieList;
  ...
  group('get Top Rated Movies', () {
    final tMovieList = MovieResponse.fromJson(json.decode(readJson('xtra_dummy/top_rated.json'))).movieList;
  ...
  group('get movie detail', () {
    const tId = 1;
    final tMovieDetail = MovieDetailResponse.fromJson(json.decode(readJson('xtra_dummy/movie_detail.json')));

    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(readJson('xtra_dummy/movie_detail.json'), 200));
      // act
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponse.fromJson(json.decode(readJson('xtra_dummy/movie_recommendations.json'))).movieList;
    const tId = 1;
  ...
  group('search movies', () {
    final tSearchResult =
        MovieResponse.fromJson(json.decode(readJson('xtra_dummy/search_spiderman_movie.json'))).movieList;
